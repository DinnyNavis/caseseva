...
class RealLegalRetrievalAdapter(LegalRetrievalAdapter):
    ...
    The corpus directory is organized by domain (backend/legal_corpus/<domain>/provisions.json).
    The corpus file is the source of truth for provision IDs and titles;
